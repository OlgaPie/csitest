...
public class PriceManagerTest {
    ...
    public void test4() throws ParseException {
        Price price11 = new Price(1L, "c1", 0, 1, sdf.parse("01.01.2013 00:00:00"), sdf.parse("10.01.2013 00:00:00"), 80);
        Price price12 = new Price(2L, "c1", 0, 1, sdf.parse("10.01.2013 00:00:00"), sdf.parse("20.01.2013 00:00:00"), 87);
        Price price13 = new Price(3L, "c1", 0, 1, sdf.parse("20.01.2013 00:00:00"), sdf.parse("31.01.2013 00:00:00"), 90);

        Price price21 = new Price(4L, "c1", 0, 1, sdf.parse("05.01.2013 00:00:00"), sdf.parse("15.01.2013 00:00:00"), 80);
        Price price22 = new Price(5L, "c1", 0, 1, sdf.parse("15.01.2013 00:00:00"), sdf.parse("25.01.2013 00:00:00"), 85);
        ...
        Assert.assertEquals(3, mergedPrices.size());

        Assert.assertEquals(sdf.parse("01.01.2013 00:00:00"), mergedPrices.get(0).getBegin());
        Assert.assertEquals(sdf.parse("15.01.2013 00:00:00"), mergedPrices.get(0).getEnd());
        Assert.assertEquals(80, mergedPrices.get(0).getValue());

        Assert.assertEquals(sdf.parse("15.01.2013 00:00:00"), mergedPrices.get(1).getBegin());
        Assert.assertEquals(sdf.parse("25.01.2013 00:00:00"), mergedPrices.get(1).getEnd());
        Assert.assertEquals(85, mergedPrices.get(1).getValue());

        Assert.assertEquals(sdf.parse("25.01.2013 00:00:00"), mergedPrices.get(2).getBegin());
        Assert.assertEquals(sdf.parse("31.01.2013 00:00:00"), mergedPrices.get(2).getEnd());
        Assert.assertEquals(90, mergedPrices.get(2).getValue());
    }
}